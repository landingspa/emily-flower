  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {loading ? (
        ...
        <>
          {/* Hero Section */}
          <section className="pt-24 pb-12 bg-linear-to-br from-rose-50 via-pink-50 to-white">
            <div className="container mx-auto px-4">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-gray-600 text-lg mb-6">
                  Khám phá bộ sưu tập hoa sáp thơm và gấu bông hoa handmade độc
                  đáo
                </p>
                    ...
                    {sortedProducts.map((product) => (
                      ...
                      >
                        <div className="relative overflow-hidden aspect-square">
                          ...
                          <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-3">
                            <Link
                              href={`/products/${product.slug}`}
                              className="bg-white text-rose-400 px-6 py-2.5 rounded-full font-medium hover:bg-rose-400 hover:text-white transition-colors text-sm md:text-base"
                            >
                              Xem chi tiết
                            </Link>
                            <button
                              ...
                              className="bg-rose-400 text-white px-6 py-2.5 rounded-full font-medium hover:bg-rose-500 transition-colors flex items-center gap-2 text-sm md:text-base"
                            >
                        ...
                        <div className="p-4 md:p-6">
                          ...
                          <Link href={`/products/${product.slug}`}>
                            <h3 className="text-base md:text-lg font-semibold text-gray-800 mb-2 line-clamp-2 hover:text-rose-400 transition-colors cursor-pointer">
                              {product.name}
                            </h3>
                          </Link>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className="p-2 bg-rose-50 rounded-full hover:bg-rose-100 transition-colors group/cart"
                            >
